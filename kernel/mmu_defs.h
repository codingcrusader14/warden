...
#define BOOT_DEVICE_BLOCK_ATTR (GLOBAL | ACCESS | SH_NON_SHAREABLE | AP_READ_WRITE | ATTRINDX(0) | BLOCK_DESCRIPTOR | VALID)
#define BOOT_NORMAL_BLOCK_ATTR (GLOBAL | ACCESS | SH_INNER_SHAREABLE | AP_READ_WRITE | ATTRINDX(1) | BLOCK_DESCRIPTOR | VALID)
...
#define KERNEL_HIGH_VA_ADDRESS 0xFFFF000000000000UL
#define PA_TO_KVA(pa) ((uint64)(pa) + KERNEL_HIGH_VA_ADDRESS)
#define KVA_TO_PA(va) ((uint64)(va) - KERNEL_HIGH_VA_ADDRESS)
